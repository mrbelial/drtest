    ...
    pages: [
      TestPageModel(
        ...
        pages: [
          ...
          TestPageModel(
            title:
                """In asymptomatic patients with INR >10, the VKA must be stopped and oral vitamin K (2.5-5 mg) prescribed, while the INR must be monitored on a daily base for 2 weeks.
(ESC VHD 2021)
The findings suggested that patients on VKA therapy who have an INR between 4.5 and 10.0 and are not bleeding are not likely to benefit from routine vitamin K administration in addition to temporary VKA cessation.
(ACC AHA VHD 2020)
In the absence of bleeding, the use of PCC and/or FFP therapy is not recommended and the decision to start vitamin K should be individualized.
(ESC VHD 2021)""",
            value: """INR > 10""",
            type: TestPageTypeEnum.page,
            pages: [inrExtra],
...
●  In such patients, warfarin should be stopped temporarily, and a small dose of
oral vitamin K (1-2 mg) can be considered on an individual basis balancing between the risks.
(ESC VHD 2021)
The findings suggested that patients on VKA therapy who have an INR between 4.5 and 10.0 and are not bleeding are not likely to benefit from routine vitamin K administration in addition to temporary VKA cessation.
(ACC AHA VHD 2020)
In the absence of bleeding, the use of PCC and/or FFP therapy is not recommended and the decision to start vitamin K should be individualized.
(ESC VHD 2021)""",
          ...
          TestPageModel(
            title:
                """Asymptomatic patients with INR< 4.5 require careful down-titration and/or skipping one or more
doses.
(ESC VHD 2021)
The findings suggested that patients on VKA therapy who have an INR between 4.5 and 10.0 and are not bleeding are not likely to benefit from routine vitamin K administration in addition to temporary VKA cessation.
(ACC AHA VHD 2020)
...
● Supportive measure.
● Hold an anticoagulant until hemostasis is achieved.
● Consider hemodialysis (Dabigatran).
...
When to resume anticoagulant?

● In most cases of nuisance or minor bleeding anticoagulation can be re-started, sometimes simply by 
delaying or skipping a single dose.
● When bleeding is due to a secondary cause (e.g., bleeding post-trauma, genitourinary bleeding due to cancer, etc.) anticoagulation can be resumed once the cause of the bleeding has been eliminated.
(EHRA NOAC AF 2021)
        """,
            value:
                "Management of Minor/ Non-life -threatening bleeding while on anticoagulant",
          ...
          TestPageModel(
            title:
                """● Consider fluid replacement, and blood transfusion, platelet replacement when indicated.
(AF ESC 2020)
● In patients with AF receiving warfarin who develop life-threatening bleeding, treatment with 4-factor
prothrombin complex concentrate (if available) in addition to intravenous vitamin K is recommended to rapidly achieve INR correction over fresh frozen plasma and intravenous vitamin K treatment.
(AHA ACC ACCP HRS 2023, 1 A)
● Activated charcoal may be administered up to 6 to 8 hours after the last dose.
...
(ACC AHA VHD 2020, 2a C-LD)
● A 10-mg intravenous dose is recommended for life-threatening bleeding when there is no concern for 
restarting the VKA within the next week.
(ACC AHA VHD 2020)
● Warfarin should be discontinued and 10 mg vitamin K should be administrated by slow i.v. infusion and repeated every 12 h if needed. Until the anticoagulation effect is reversed, administration of prothrombin complex concentration (PCC) and/or fresh frozen plasma (FFP) therapy should be initiated.
(ESC VHD 2021)
...
(AF ESC 2020)""",
            ...
            pages: [
              ...
              TestPageModel(
                title:
                    """● In patients with AF who develop major gastrointestinal bleeding, resumption of oral anticoagulation
therapy may be reasonable after correction of reversible causes of bleeding and reassessment of its long term benefits and risks with a multidisciplinary team approach during SDM with patients.
(AHA ACC ACCP HRS 2023, 2b B-NR)
● VKAs must be resumed once the INR achieves the therapeutic range or is slightly elevated.
(ESC VHD 2021)""",
                value:
...
●  Need to undergo urgent surgery""",
            ...
            pages: [
              TestPageModel(
                title:
                    """● Consider fluid replacement, blood transfusion, platelet replacement when indicated.
(AF ESC 2020)
●  In patients with AF receiving dabigatran who develop life-threatening bleeding, treatment with idarucizumab is recommended to rapidly reverse dabigatran’s anticoagulation effect.
(AHA ACC ACCP HRS 2023, 1 B-NR)
● In patients with AF receiving dabigatran who develop life-threatening bleeding, treatment with activated prothrombin complex concentrate (PCC) is reasonable to reverse dabigatran’s anticoagulation effect if idarucizumab is unavailable.
(AHA ACC ACCP HRS 2023, 2a C-LD)
● Activated charcoal may be administered up to 6 to 8 hours after the last dose of an OAC.
(AHA ACC ACCP HRS 2023)
● Hemodialysis may be also considered to eliminate dabigatran but may be challenging and impractical due to coagulopathy and hemodynamic instability.
(AHA ACC ACCP HRS 2023)
...
(AHA ACC HRS 2019, I B-NR)
● If idarucizumab is not available, dialysis may be used to partially eliminate dabigatran from the circulation.
(EHRA NOAC AF 2021)
● Fresh frozen plasma (FFP) is no longer considered a useful reversal strategy. In the case of recent acute ingestion of an overdose (especially when ≤2 h ago), the use of activated charcoal to reduce absorption may be considered for any NOAC (with a standard dosing scheme for adults of 30 – 50 g)
(EHRA NOAC AF 2021)""",
                value: "Dabigatran",
                type: TestPageTypeEnum.page,
  ...
  var aFICH = TestPageModel(
    ...
    pages: [
      TestPageModel(
        title:
            """●  In patients with AF and conditions associated with very high risk of thromboembolic events (>5%/year), early (1-2 weeks) resumption of anticoagulation after ICH is reasonable to reduce the risk of thromboembolic events.
(AHA ACC ACCP HRS 2023, 2a C-LD)
● LAA occlusion is a potential alternative strategy to long-term anticoagulation in this setting.
(EHRA NOAC AF 2021)""",
        value:
            """Is the patient at very high risk of thromboembolic events (>5%/year),
or any of the following present?
● Mechanical heart valve
● Rheumatic valve disease
● Previous history of stroke/
Thromboembolism
● High CHA2DS2-VASc score (>5)
● Hypercoagulable state (e.g., active
malignancy, genetic thrombophilia)""",
        type: TestPageTypeEnum.end,
      ),
      TestPageModel(
        title:
            """●  In patients with AF and conditions associated with high risk of recurrent ICH (e.g., cerebral amyloid angiopathy) anticoagulation-sparing strategies (e.g., LAAO) may be considered to reduce the risk of recurrent hemorrhage.
(AHA ACC ACCP HRS 2023, 2b B-NR)
● LAA occlusion is a potential alternative strategy to long-term anticoagulation in this setting.
(EHRA NOAC AF 2021)
●   All DOAC groups showed significantly lower risks of intracranial hemorrhage (ICH) compared with warfarin.
(AHA ACC ACCP HRS 2023)""",
        value:
...
malformation or aneurysm""",
      ...
      TestPageModel(
        title:
            """● In patients with AF and ICH, delayed (4-8 weeks) resumption of anticoagulation may be considered to balance the risks of thromboembolic and hemorrhagic complications after careful risk benefit assessment.
(AHA ACC ACCP HRS 2023, 2b C-LD)
● “NOACs should preferentially be used over VKA in this setting” 
ESO guideline concludes that “restarting oral anticoagulation can be considered after careful weighing of risks and benefits.
● NOACs may be re-started 4-8 weeks after ICB, if the individual risk of cardio-embolic stroke is high and the risk of recurrent ICB is estimated to be lower.
(EHRA NOAC AF 2021)
● LAA occlusion is a potential alternative strategy to long-term anticoagulation in this setting.
● Consider (re-)initiation of (N)OAC after 4-8 weeks after multidisciplinary team assessment.
(EHRA NOAC AF 2021)
●   All DOAC groups showed significantly lower risks of intracranial hemorrhage (ICH) compared with warfarin.
(AHA ACC ACCP HRS 2023)""",
...
In patients who develop postoperative AF after cardiac surgery, it is reasonable to administer anticoagulation when deemed safe in regard to surgical bleeding for 60 days after surgery unless complications develop and to reevaluate the need for longer term anticoagulation.
(AHA ACC ACCP HRS 2023 2a, B-NR)
Long-term OAC therapy to prevent thromboembolic events should be considered in patients
at risk for stroke with postoperative AF after non-cardiac surgery, considering the anticipated net clinical benefit of OAC therapy and informed patient preferences.
(AF ESC 2020, IIa B)
Long-term OAC therapy to prevent thromboembolic events may be considered in patients at
risk for stroke with postoperative AF after cardiac surgery, considering the anticipated net clinical benefit of OAC therapy and informed patient preferences.
(AF ESC 2020, IIb B)""",
  ...
  var aFduetoHyperthyroidism = TestPageModel(
    title: """What is the duration of anticoagulant therapy?
n patients with hyperthyroidism and AF who have an elevated risk of stroke based on a standard clinical risk score, anticoagulation is recommended until thyroid function has returned to normal and sinus rhythm can be maintained.
(AHA ACC ACCP HRS 2023 1, B-NR)
In AF patients with hyperthyroidism, spontaneous conversion of AF often occurs once a euthyroid state is achieved.
(AF ESC 2020)""",
...
In patients with IE and with evidence of 
...
Anticoagulation.
(ACC AHA VHD 2020, 2a B-NR)
In patients receiving VKA anticoagulation 
at the time of IE diagnosis, temporary 
discontinuation of VKA anticoagulation may 
be considered.
(ACC AHA VHD 2020, 2b B-NR)
In patients on anticoagulant therapy for AF or a mechanical heart valve, continued anticoagulation is associated with a higher risk of intracranial bleeding, particularly after an embolic event.
(ACC AHA VHD)""",
...
● In patients with concomitant AF, the combination of a single antiplatelet agent (aspiring or clopidogrel) with a NOAC appears reasonable.
● One year post-CABG, NOACs may be continued 
as monotherapy.
(EHRA NOAC AF 2021)""",
    value: "AF + CABG",
    type: TestPageTypeEnum.end,
...
When SAH  occurs in AF patients taking a NOAC in the absence of a remediable etiology it seems prudent not to re-initiate OAC treatment. 
LAA closure may be considered (no RCT data available), ideally in the 
framework of a randomized trial. 
Treatment of any underlying aneurysm or arteriovenous malformation is recommended before resuming OAC.
(EHRA NOAC AF 2021)""",
...
● It appears to be safe to start or reinitiate OAC about 4 weeks after (surgical removal of) traumatic epidural or subdural hematoma, particularly in the absence of drug / alcohol abuse or a substantial risk of falling.
●  According to clinical presentation and hematoma extension, brain imaging (using CT or MRI) is recommended before (re-) starting OAC. However, adequately dosed NOAC or no anticoagulation at the time of non-traumatic epidural or subdural hematoma does not support (re-) initiation of oral anticoagulation despite the fact that the risk of ischemic stroke is increased within 4 weeks after nontraumatic SDH according to a retrospective US cohort study.
(EHRA NOAC AF 2021)""",
    ...
    pages: [
      TestPageModel(
        ...
        pages: [
          TestPageModel(
            title:
                """● A forgotten dose may be taken until half of the dosing interval has passed.
● For NOACs with a twice-daily (BID) dosing regimen (i.e. every 12 h), a forgotten full dose can be taken up until 6 h after the scheduled intake.
● After these time points, the dose should be skipped, and the next scheduled dose should be taken.
(EHRA NOAC AF 2021)""",
          ...
          TestPageModel(
            title:
                """● A forgotten dose may be taken until half of the dosing interval has passed.
● For NOACs with a once-daily (QD) dosing regimen, a forgotten dose can be 
taken up until 12 h after the scheduled intake. 
● After these time points, the dose should be skipped, and the next scheduled dose should be taken.
(EHRA NOAC AF 2021)""",
...
(EHRA NOAC AF 2021)""",
          ...
          TestPageModel(
            ...
            pages: [
              TestPageModel(
                title:
                    """●For NOACs with a QD dosing regimen, when thromboembolic risk is high (CHA2DS2-VASc ≥3), it may generally be advisable to take another tablet 6-8 hours after the original (uncertain) intake and then continue the planned dose regimen.
(EHRA NOAC AF 2021)""",
              ...
              TestPageModel(
                title:
                    """● In case the thromboembolic risk is low (CHA2DS2-VASc ≤2) we advise to wait until the next scheduled dose.
(EHRA NOAC AF 2021)""",
  ...
  var administrationOfDOACInCrushedForm = TestPageModel(
    ...
    pages: [
      TestPageModel(
        title:
            """Administration in crushed form, e.g., via a nasogastric tube, does not alter the bioavailability for apixaban, rivaroxaban and edoxaban.
(EHRA NOAC AF 2021)""",
        value: "Apixaban Rivaroxaban Edoxaban",
        type: TestPageTypeEnum.end,
      ),
      TestPageModel(
        title:
            """Dabigatran capsules must not be opened as this results in a substantial increase in drug bioavailability (+75% per SmPC). 
(EHRA NOAC AF 2021)""",
        value: "Dabigatran",
        type: TestPageTypeEnum.end,
      ),
  ...
  var switchingBetweenAnticoagulants = TestPageModel(
    title: "",
    value: "Switching between anticoagulants (EHRA NOAC AF 2021)",
    type: TestPageTypeEnum.page,
    pages: [
      TestPageModel(
        title: "Stop Warfarin and check INR  daily.",
        value: "Warfarin to DOAC",
        type: TestPageTypeEnum.page,
        pages: [
          TestPageModel(
            title: "Postpone NOAC Check INR daily.",
            value: "INR ≥ 3",
            type: TestPageTypeEnum.end,
          ),
          TestPageModel(
            title: "start NOAC immediately",
            value: "INR ≤ 2",
            type: TestPageTypeEnum.end,
          ),
          TestPageModel(
            title: "start NOAC immediately or next day",
            value: "INR 2-2.5",
            type: TestPageTypeEnum.end,
          ),
          TestPageModel(
      ...
      TestPageModel(
        title: """● Continue NOAC  (half dose for edoxaban)
● Start Warfarin.
● Measure INR after 3-5 days (before NOAC intake)""",
        ...
        pages: [
          TestPageModel(
            title: """● Continue NOAC (half dose for edoxaban)
● Continue Warfarin.
● Repeat INR after 1-3 days (before NOAC intake)""",
            value: "INR < 2",
            type: TestPageTypeEnum.end,
          ),
          TestPageModel(
            title: """● Stop DOAC.
● Continue Warfarin.
● Repeat INR 1 day after stopping DOAC.""",
            value: "INR ≥ 2",
            type: TestPageTypeEnum.end,
          ),
        ],
      ...
      TestPageModel(
        title: """Start NOAC (2-) 4 hours after stopping UFH.""",
        value: "UFH to NOAC",
        type: TestPageTypeEnum.end,
      ),
      TestPageModel(
        title:
            """Start UFH 12 (BID NOAC) - 24 (QD NOAC) hours after last NOAC intake.""",
        value: "NOAC to UFH",
        type: TestPageTypeEnum.end,
      ),
      TestPageModel(
        title: "Substitue QD NOAC at the time of the next dose.",
        value: "From BID NOAC to QD NOAC",
        type: TestPageTypeEnum.end,
      ),
      TestPageModel(
        title: "substitute BID NOAC at the time of the next dose.",
        value: "From QD NOAC to BID NOAC",
        type: TestPageTypeEnum.end,
      ),
      TestPageModel(
        title: "substitute LMWH at the time of the next dose.",
...
Patients at increased risk of AF should receive comprehensive guideline-directed LRFM for AF, targeting
obesity, physical inactivity, unhealthy alcohol consumption, smoking, diabetes, and hypertension.
(AHA ACC ACCP HRS 2023 I B-NR)""",
    value: "Modifiable risk factors in AF patients",
    type: TestPageTypeEnum.page,
    pages: [
      TestPageModel(
        title:
            """In patients with AF who are overweight or obese (with body mass index [BMI] >27 kg/m2), weight loss is
recommended, with an ideal target of at least 10% weight loss to reduce AF symptoms, burden, recurrence, and progression to persistent.
(AHA ACC ACCP HRS 2023 I B-R)""",
        value:
      ...
      TestPageModel(
        title:
            """In individuals with AF, moderate-to-vigorous exercise training to a target of 210 minutes per week is
recommended to reduce AF symptoms and burden, increase maintenance of sinus rhythm, increase
functional capacity, and improve QOL.
(AHA ACC ACCP HRS 2023 I B-R)""",
        value:
      ...
      TestPageModel(
        title:
            """●  Patients with a history of AF who smoke cigarettes should be strongly advised to quit smoking and should
receive GDMT for tobacco cessation to mitigate increased risks of AF-related cardiovascular complications and other adverse outcomes.
(AHA ACC ACCP HRS 2023 I B-NR)
● Cigarette smoking was associated with less time in therapeutic range for patients on warfarin.""",
      ...
      TestPageModel(
        title:
            """Patients with AF seeking a rhythm-control strategy should minimize or eliminate alcohol consumption to
reduce AF recurrence and burden.
(AHA ACC ACCP HRS 2023 I B-R)""",
        value:
      ...
      TestPageModel(
        title:
            """For patients with AF, recommending caffeine abstention to prevent AF episodes is of no benefit, although
it may reduce symptoms in patients who report caffeine triggers or worsens AF symptoms.
(AHA ACC ACCP HRS 2023 No Benefit B-NR)""",
        value:
      ...
      TestPageModel(
        title:
            """For patients with AF and hypertension, optimal BP control is recommended to reduce AF recurrence and AF-related cardiovascular events.
(AHA ACC ACCP HRS 2023 I B-NR)""",
        value:
      ...
      TestPageModel(
        title:
            """Among patients with AF, it may be reasonable to screen for obstructive sleep apnea, given its high prevalence in patients with AF, although the role of treatment of sleep-disordered breathing (SDB) to maintain sinus rhythm is uncertain.
(AHA ACC ACCP HRS 2023 2b B-NR)""",
        value:
...
(AHA ACC ACCP HRS 2023 No benefit B-R)""",
    value: "AF monitoring",
    type: TestPageTypeEnum.page,
    pages: [
      TestPageModel(
        title:
            """Typically, periodic assessment should be performed once a year but might need to be performed more frequently in the context of changes in clinical status, such as reduction in renal function or
development of additional risk factors.
(AHA ACC ACCP HRS 2023)""",
        value:
      ...
      TestPageModel(
        ...
        pages: [
          TestPageModel(
            title: """Consider bleeding risk assessment every 6 months.
(AHA ACC ACCP HRS 2023)""",
          ...
          TestPageModel(
            title: """Consider bleeding risk assessment every 3 months.
(AHA ACC ACCP HRS 2023)""",
      ...
      TestPageModel(
        ...
        pages: [
          TestPageModel(
            title: """Consider renal function assessment every 6 months.
(AHA ACC ACCP HRS 2023)""",
            value: "CrCl < 30",
            type: TestPageTypeEnum.end,
          ...
          TestPageModel(
            title: """Consider renal function assessment every 3 months.
(AHA ACC ACCP HRS 2023)""",
            value: "CrCl: 30-59",
            type: TestPageTypeEnum.end,
          ...
          TestPageModel(
            title: """Consider renal function assessment every 1-2 months.
(AHA ACC ACCP HRS 2023)""",
            value: "CrCl > 60",
            type: TestPageTypeEnum.end,
...
(AHA ACC ACCP HRS 2023)""",
          ...
          TestPageModel(
            title: """Consider liver function assessment every 3 months.
(AHA ACC ACCP HRS 2023)""",
            value: "Child-Pugh: B",
            type: TestPageTypeEnum.end,
          ...
          TestPageModel(
            title: """Consider liver function assessment every 6 months.
(AHA ACC ACCP HRS 2023)""",
            value: "Child-Pugh: C",
            type: TestPageTypeEnum.end,
          ...
          TestPageModel(
            title: """Consider liver function assessment every 12 months.
(AHA ACC ACCP HRS 2023)""",
...
dual therapy (anticoagulation plus aspirin or P2Y12 inhibitors) to reduce the risk of bleeding.
(AHA ACC ACCP HRS 2023 2a, B-NR)""",
    value: "Antithrombotic therapy in AF patients with concurrent PAD",
    type: TestPageTypeEnum.end,
  );
...
● In patients with CCD who have undergone elective PCI and who require oral anticoagulant therapy, DAPT for 1 to 4 weeks followed by clopidogrel alone for 6 months should be administered in addition to DOAC.
(AHA/ACC/ACCP/ASPC/NLA/PCNA CCD 2023 I B-R)
● In patients with CCD who have undergone PCI and who require oral anticoagulant therapy, continuing aspirin in addition to clopidogrel for up to 1 month is reasonable if the patient has a high thrombotic risk (Complex lesions, previous MI, extensive CVD, cardiovascular risk factors) and low bleeding risk.
(AHA/ACC/ACCP/ASPC/NLA/PCNA CCD 2023 2a B-R)
● In patients with CCD who require oral anticoagulation and have a low atherothrombotic risk, discontinuation of aspirin therapy with continuation of DOAC alone may be considered 1 year after PCI to reduce bleeding risk.
(AHA/ACC/ACCP/ASPC/NLA/PCNA CCD 2023 2b B-R)
● In patients with CCD who require oral anticoagulation, DOAC monotherapy may be considered if there is no acute indication for concomitant antiplatelet therapy.
(AHA/ACC/ACCP/ASPC/NLA/PCNA CCD 2023 2b C-LD)
● In patients with AF and CCD (beyond 1 year after revascularization or CAD not requiring coronary revascularization) without history of stent thrombosis, oral anticoagulation monotherapy is recommended over the combination therapy of OAC and single APT (aspirin or P2Y12 inhibitor) to decrease the risk of major bleeding.
(AHA ACC ACCP HRS 2023 1, B-R)""",
    value: "AF + CCS",
    type: TestPageTypeEnum.end,
  );
  ...
  var aFACS = TestPageModel(
    ...
    pages: [
      TestPageModel(
        title:
            """● After up to 1 week of triple antithrombotic therapy following the ACS event, 
dual antithrombotic therapy using a NOAC at the recommended dose for stroke prevention and a single oral antiplatelet agent (preferably clopidogrel) 
for up to 12 months is recommended.
(ESC ACS 2023 I A)
● In patients treated with an OAC, aspirin plus clopidogrel for longer than 1 week and up to 1 month should be considered in those with high ischemic risk or with other anatomical/procedural characteristics that are judged to outweigh the bleeding risk.
(ESC ACS 2023 II C)
...
UFH in patients with STEMI undergoing PPCI.
(ESC ACS 2023 IIa A)
(No parenteral anticoagulation is needed if the INR is >2.5.)
(Perform PCI without interruption of VKAs or NOACs.)
(ESC ACS 2023)""",
        value:
        ...
        pages: [
          TestPageModel(
            title:
                """During PCI: 70–100 U/kg i.v. bolus or according to activated clotting time in case of UFH pre-treatment.
(ESC ACS 2023)""",
            ...
            pages: [
              TestPageModel(
                ...
                pages: [
                  ...
                  TestPageModel(
                    title:
                        """If the last s.c. administration was given more than 8 h before balloon inflation, an i.v. bolus of 0.3 mg/kg enoxaparin sodium should be administered.
(ESC ACS 2023)""",
                    value: "No",
                    type: TestPageTypeEnum.end,
                  ),
              ...
              TestPageModel(
                title: """I.v. bolus of 0.3 mg/kg enoxaparin sodium should be 
administered.
(ESC ACS 2023)""",
                value: "No",
                type: TestPageTypeEnum.end,
      ...
      TestPageModel(
        title: """● Perform PCI without interruption of VKAs or NOACs.
(ESC ACS 2023)
● Observational studies indicate that PCI on uninterrupted VKAs
is generally safe compared with OAC interruption and heparin-bridging therapy.
● Studies on NOACs are conflicting, predominantly discouraging a PCI on fully uninterrupted NOAC therapy.
(EHRA NOAC AF 2021)""",
    ...
    pages: [
      TestPageModel(
        ...
        pages: [
          TestPageModel(
            title:
                """● During the ablation, intravenous heparin should be administered to achieve an activated clotting time (ACT) of 300 – 350 seconds.
(EHRA NOAC AF 2021)
● All patients undergoing catheter ablation require intraprocedural intravenous anticoagulation with heparin or direct thrombin inhibitors in those with heparin allergies.
(AHA ACC ACCP HRS 2023)""",
...
(EHRA NOAC AF 2021)""",
              ...
              TestPageModel(
                title:
                    """● In patients on a DOAC who are undergoing catheter ablation of AF, catheter ablation should be performed with either continuous or minimally interrupted oral anticoagulation.
(AHA ACC ACCP HRS 2023 1, A)
● There is no reason to recommend omitting one or two NOAC doses before ablation.
After the procedure, administration of the first dose the evening after ablation or the next morning appears to be safe.
(AF ESC 2020)
● For patients undergoing AF catheter ablation who have been therapeutically anticoagulated with warfarin, dabigatran, rivaroxaban, apixaban, or edoxaban, performance of the ablation procedure without OAC interruption is recommended.
(AF ESC 2020, I A)
●  Performing left atrial catheter ablation under uninterrupted anticoagulant treatment with VKA (target INR 2.0-2.5 if on VKAs) and uninterrupted NOAC therapy can be considered safe and effective in AF ablation and should likely be the preferred mode of anticoagulation for patients undergoing this procedure.
(EHRA NOAC AF 2021)
● NOAC interruption might be considered 12 hours before ablation. (Shorter interruption period may be considered if High CHA2DS2VASc Score≥ 4).
(EHRA NOAC AF 2021)
● The last dose of once-daily based NOACs were recommended (rivaroxaban) or mandated (edoxaban) to be administered in the evening before the procedure whereas twice-daily dosed NOACs (apixaban, dabigatran) were administered in the morning of the procedure.
(EHRA NOAC AF 2021)


When to reinitiate DOAC following ablation?

NOAC intake can be resumed 3 - 5 hours after sheath removal if adequate hemostasis is established and pericardial effusion has been ruled out.
(EHRA NOAC AF 2021)""",
                value: "DOAC",
                type: TestPageTypeEnum.end,
              ),
...
(AHA ACC ACCP HRS 2023 1, B-NR)
In AF patients with stroke risk factors not taking OAC before ablation, it is recommended that pre-procedural management of stroke risk includes initiation of anticoagulation and preferably, therapeutic OAC for at least 3 weeks before ablation (I C), or alternatively, the use of TOE to exclude LA thrombus before ablation (II C).
(AF ESC 2020)""",
              ...
              TestPageModel(
                title:
                    """● In patients who have undergone catheter ablation of AF, continuation of longer-term oral anticoagulation should be dictated according to the patients’ stroke risk (eg, CHA2DS2-VAScscore ≥ 2)
(AHA ACC ACCP HRS 2023 1, B-NR)
● Systemic anticoagulation with warfarin or a NOAC is continued for at least 2 (AF ESC 2020, I C) or 3 months (AHA ACC ACCP HRS 2023 1, B-NR) post ablation, and Long-term continuation of systemic anticoagulation beyond 2 months post ablation is based on the patient’s stroke risk profile and not on the apparent success or failure of the ablation procedure.
(AF ESC 2020, I C)
(AHA ACC ACCP HRS 2023 1, B-NR)""",
      ...
      TestPageModel(
        ...
        pages: [
          TestPageModel(
            title:
                """In patients undergoing surgical ablation, anticoagulation therapy is reasonable for at least 3 months after the procedure to reduce the risk of stroke or systemic embolism.
(AHA ACC ACCP HRS 2023 2a, B-NR)""",
            value: "During the first 3 months",
            type: TestPageTypeEnum.end,
          ),
          TestPageModel(
            title: """Consider CHA2DS2-VASc score.
(AHA ACC ACCP HRS 2023)""",
            value: "After the first 3 months",
            type: TestPageTypeEnum.end,
          ),
...
● For patients with AF or atrial flutter of less than 48 hours’ duration with a CHA2DS2-VASc score of 2 or greater in men and 3 or greater in women, administration of heparin, a factor Xa inhibitor, or a direct thrombin inhibitor is reasonable as soon as possible before cardioversion, followed by long-term 
anticoagulation therapy. (AHA ACC HRS 2019, IIa B-NR)""",
        value:
      ...
      TestPageModel(
        title:
            """4 weeks after cardioversion when AF duration of ≥24 hours (ESC 2020 AF IIa B), or ≥ 48 hours (AHA/ACC/HRS 2019 I B-R), or regardless of duration (AHA/ACC/ACCP/HRS AF 2023, 1 B-NR).""",
        value:
      ...
      TestPageModel(
        title:
            """In patients with AF in whom cardioversion is deferred due to LAA thrombus detected on precardioversion
imaging, therapeutic anticoagulation should be instituted for at least 3 to 6 weeks, after which imaging
should be repeated before cardioversion.
(AHA ACC ACCP HRS 2023 1, C-LD)""",
        value:
  ...
  var aFIschemicStrokeOrTIA = TestPageModel(
    ...
    pages: [
      TestPageModel(
        title:
            """In AF patients with an ischemic stroke or TIA, long-term secondary prevention of stroke using OAC is recommended if there is nostrict contraindication to OAC use, with a preference for NOACs over VKAs in NOAC-eligible patients.
(AF ESC 2020, I A)""",
        value:
      ...
      TestPageModel(
        title:
            """In AF patients presenting with acute ischemic stroke, very early anticoagulation (<48 h) using UFH, LMWH, or VKAs is not recommended.
(AF ESC 2020, III B)""",
        value:
...
Consider (re-) starting NOAC therapy after 1 day.
(EHRA NOAC AF 2021)""",
      ...
      TestPageModel(
        ...
        pages: [
          TestPageModel(
            ...
            pages: [
              TestPageModel(
                title: """Consider Holding Warfarin.
(CHEST 2022)
...
Low-to-moderate-bleed-risk surgery/procedures
...
● Bronchoscopy ±  biopsy""",
              ...
              TestPageModel(
                title: """Minimal-bleed-risk surgery/procedures (30-d
...
● Pacemaker or cardioverter-defibrillator device implantation""",
                ...
                pages: [
                  TestPageModel(
                    title:
                        """● In patients receiving VKA therapy who need a dental procedure, we suggest continuation of VKA
over VKA interruption. 
( CHEST 2022, Conditional Recommendation,
Low Certainty of Evidence)
● Minor procedures including surgery on the skin, dental cleaning, or simple treatment for dental caries, eye surgery, particularly for cataracts or glaucoma, is usually associated with very little bleeding risk is frequently performed without alteration of anticoagulation.
(ACC AHA VHD 2020)
 ● For minor surgical procedures (e.g. dental, cataract, skin incision) in which blood loss is usually small and easily controlled, it is recommended that OAC is not interrupted.
(ESC VHD 2021)""",
                    value: "Minor dental procedure",
                    type: TestPageTypeEnum.end,
                  ),
                  TestPageModel(
                    title: """● In patients receiving VKA therapy who require a
minor dermatologic procedure, we suggest
continuation of VKA over VKA interruption.
(CHEST 2022, Conditional Recommendation, Very Low Certainty of
Evidence)
● Minor procedures including surgery on the skin, dental cleaning, or simple treatment for dental caries, eye surgery, particularly for cataracts or glaucoma, is usually associated with very little bleeding risk is frequently performed without alteration of anticoagulation.
(ACC AHA VHD 2020)
 ● For minor surgical procedures (e.g. dental, cataract, skin incision) in which blood loss is usually small and easily controlled, it is recommended that OAC is not interrupted.
...
continuation of VKA over VKA interruption.
(CHEST 2022, Conditional Recommendation, Very Low Certainty of Evidence)
● Minor procedures including surgery on the skin, dental cleaning, or simple treatment for dental caries, eye surgery, particularly for cataracts or glaucoma, is usually associated with very little bleeding risk is frequently performed without alteration of anticoagulation.
(ACC AHA VHD 2020)
 ● For minor surgical procedures (e.g. dental, cataract, skin incision) in which blood loss is usually small and easily controlled, it is recommended that OAC is not interrupted.
(ESC VHD 2021)""",
...
heparin bridging. 
(CHEST 2022, Strong Recommendation, Moderate
Certainty of Evidence)
●  In patients with AF on warfarin anticoagulation and an annual predicted risk of thromboembolism of ≥ 5% undergoing pacemaker or defibrillator implantation or generator change, continued anticoagulation is recommended in preference to interruption of warfarin and bridging anticoagulation with heparin to reduce the risk of pocket hematoma.
(AHA ACC ACCP HRS 2023 1, A)""",
...
undergoing pacemaker or defibrillator implantation or generator change?""",
          ...
          TestPageModel(
            ...
            pages: [
              TestPageModel(
                title: """●  In patients requiring VKA (warfarin) interruption
for an elective surgery/procedure, we suggest stopping VKAs (warfarin) ≥  5 days over an interruption of < 5 days before an elective surgery/procedure.
(CHEST 2022, Conditional Recommendation, Low Certainty of
Evidence).
● It is recommended that VKAs are timely discontinued (<_5 days for warfarin) prior to elective surgery to aim for an INR <1.5.
(ESC VHD 2021, I C)""",
                value:
...
OR
● Hold anticoagulant 2-3 days preprocedural for a target INR<2.
(AHA ACC ACCP HRS 2023)
...
(including:
Endoscopic, dental extraction, many ophthalmologic procedures, and percutaneous vascular access, such as cardiac catheterization.)
See the complete list of Low-to-moderate-bleed-risk procedures""",
                    type: TestPageTypeEnum.end,
                  ),
                  TestPageModel(
...
(including:
Intra-abdominal, pelvic, orthopedic, neurosurgical, cardiac, and transvenous lead extraction procedures neuraxial anesthesia, and spinal surgery)
See the complete list of high-bleed-risk procedures""",
                    type: TestPageTypeEnum.end,
                  ),
                ],
              ...
              TestPageModel(
                title: """In patients requiring VKA interruption for an
...
(CHEST 2022, Conditional Recommendation, Low Certainty of
Evidence).
● Warfarin can be resumed on the evening of procedure (D0) for most patients, or the day after procedure.
(CHEST 2022)
● Warfarin, which takes several days (usually 3-5) to become therapeutic, can often be restarted the evening of the procedure. Postoperative bridging anticoagulation has not been shown to be generally beneficial.
(AHA ACC ACCP HRS 2023)""",
                value:
...
the usual dose.
(CHEST 2022, Conditional Recommendation, Very
Low Certainty of Evidence)""",
                value:
                ...
                pages: [
                  TestPageModel(
                    ...
                    pages: [
                      TestPageModel(
                        title:
                            """● In patients receiving VKA therapy for a mechanical
heart valve who require VKA interruption for an
elective surgery/procedure, we suggest against heparin
Bridging.
(CHEST 2022, Conditional Recommendation, Very Low
Certainty of Evidence).
●  Patients with mechanical valves, and recent stroke/TIA, or other high-risk markers, were not
included in most studies and may still benefit from bridging anticoagulation: in these scenarios, management should be individualized.
● In patients with AF on warfarin anticoagulation, who are undergoing surgeries or procedures for which they are holding warfarin, except in patients with mechanical valve or recent stroke or TIA, bridging anticoagulation with low-molecular-weight heparin should not be administered.
(AHA ACC ACCP HRS 2023 Harm, B-R)
● For patients who are undergoing invasive procedures and have 1) a mechanical AVR 
...
For patients with a mechanical valve prosthesis 
...
(ACC AHA VHD 2020, 2a C-LD)""",
                  ...
                  TestPageModel(
                    title: """● In patients receiving VKA therapy for atrial
fibrillation who require VKA interruption for an
elective surgery/procedure, we recommend against
heparin bridging.
 (CHEST 2022, Strong Recommendation, Moderate
Certainty of Evidence).
Bridging of OAC is recommended when CHA2DS2-VASc score >_3 for women or 2 for men.
(ESC VHD 2021, I C)""",
                    value:
                  ...
                  TestPageModel(
                    title: """In patients receiving VKA therapy for VTE as the
...
Low Certainty of Evidence).""",
                  ...
                  TestPageModel(
                    title: """● In patients receiving VKA therapy who are
...
• High acute thromboembolic risk including: (LV apex thrombus, antithrombin 3 deficit and proteins C and/or S deficit)
(ESC VHD 2021, I C)""",
                    value:
...
● AF with significant mitral stenosis (ESC VHD 2021)""",
                  ...
                  TestPageModel(
                    title:
                        """In patients receiving VKA therapy who are classified
...
Evidence)""",
                  ...
                  TestPageModel(
                    title: """In patients receiving VKA therapy who require
VKA interruption for a colonoscopy with anticipated
polypectomy, we suggest against heparin bridging
during the period of VKA interruption.
 (CHEST 2022, Conditional
Recommendation, Very Low Certainty of Evidence)""",
                  ...
                  TestPageModel(
                    title:
                        """In patients with AF (excluding those with recent stroke or TIA, or a mechanical valve) and on oral anticoagulation with either warfarin (1 B-R) or DOAC (1 B-NR) who are scheduled to undergo an invasive procedure or surgery, temporary cessation of oral anticoagulation without bridging anticoagulation is recommended.
(AHA ACC ACCP HRS 2023)""",
...
(ESC VHD 2021, I B)
● Bridging therapy with unfractionated heparin or low-molecular-weight heparin is recommended for patients with AF and a mechanical heart valve undergoing procedures that require interruption of 
warfarin.
(AHA ACC HRS 2019, I C)""",
                ...
                pages: [
                  TestPageModel(
                    ...
                    pages: [
                      TestPageModel(
                        title: """In patients receiving therapeutic-dose IV UFH
...
Certainty of Evidence)""",
                  ...
                  TestPageModel(
                    ...
                    pages: [
                      TestPageModel(
                        title: """● In patients receiving LMWH bridging for an
elective surgery/procedure, we suggest administering
the last pre-operative LMWH bridging dose at
approximately 24 hours over administering the last dose 10 to 12 hours before a surgery/procedure.
(CHEST 2022, Conditional Recommendation, Very Low Certainty of
Evidence).
● The last dose given the AM of the day prior to the procedure at half the total daily dose.
(CHEST 2022)""",
                        value:
...
Very Low Certainty of Evidence).""",
                      ...
                      TestPageModel(
                        title:
                            """● In patients receiving LMWH bridging for an elective surgery/procedure, we suggest administering the first post-operative LMWH bridging dose at least 24 hours after a surgery/procedure over administering it less than 24 hours after a surgery/
Procedure.  (CHEST 2022, Conditional Recommendation, Very Low Certainty of Evidence).
● For high-bleed-risk surgery/procedure: Consider Low-dose LMWH (e.g., enoxaparin, 40 mg daily)  for VTE prophylaxis for first 24-72 hours post-procedure, with full dose LMWH resumed 2-3 days post-procedure.
...
● For patients on DOAC with creatinine clearance lower than the values in the table, few
clinical data exist. Consider holding for an additional 1 to 3 days, especially for high bleeding risk procedures.
(CHEST 2022, AHA ACC ACCP HRS 2023)""",
                    value:
...
clinical data exist. Consider holding for an additional 1 to 3 days, especially for high bleeding risk procedures.
(CHEST 2022, AHA ACC ACCP HRS 2023)""",
                    value: """Is the surgery/procedure high-bleed-risk?
See the complete list of high-bleed-risk surgery/procedure
+
(CrCl >25 mL/min)""",
                    type: TestPageTypeEnum.end,
                  ),
          ...
          TestPageModel(
            ...
            pages: [
              TestPageModel(
                title: """In patients receiving dabigatran who require an
elective surgery/procedure, we suggest stopping
...
(CHEST 2022, AHA ACC ACCP HRS 2023)""",
                  ...
                  TestPageModel(
                    ...
                    pages: [
                      TestPageModel(
                        title: """● Consider 2 days off.
● ● For patients on DOAC with creatinine clearance lower than the values in the table, fewclinical data exist. Consider holding for an additional 1 to 3 days, especially for high bleeding risk procedures.
(CHEST 2022, AHA ACC ACCP HRS 2023)""",
                        value: "Low-to-moderate-bleed-risk surgery/procedure?",
                        type: TestPageTypeEnum.end,
                      ),
...
(CHEST 2022, AHA ACC ACCP HRS 2023)""",
          ...
          TestPageModel(
            ...
            pages: [
              TestPageModel(
                title: """In patients receiving edoxaban who require an
elective surgery/procedure, we suggest stopping
edoxaban for 1 to 2 days before the surgery/procedure
over edoxaban continuation.
 (CHEST 2022, Conditional Recommendation, Very Low Certainty of Evidence).
...
(CHEST 2022, AHA ACC ACCP HRS 2023)""",
                    value:
                        "Low-to-moderate-bleed-risk surgery/procedure?\n+\n(CrCl >15 mL/min)",
                    type: TestPageTypeEnum.end,
                  ),
                  TestPageModel(
                    title: """● Consider 2 days off.
...
(CHEST 2022, AHA ACC ACCP HRS 2023)""",
          ...
          TestPageModel(
            ...
            pages: [
              TestPageModel(
                title: """In patients receiving rivaroxaban who require an
elective surgery/procedure, we suggest stopping
...
(CHEST 2022, AHA ACC ACCP HRS 2023)""",
          ...
          TestPageModel(
            title: """● In patients who require DOAC interruption for an
elective surgery/procedure, we suggest against
perioperative heparin bridging.
 (CHEST 2022, Conditional Recommendation, Very Low Certainty of Evidence).
● Pre-operative bridging with low-molecular weight (LMWH) or unfractionated heparin (UFH) is not recommended in NOAC-treated patients.
(EHRA NOAC AF 2021)""",
            value:
...
resuming DOACs within 24 hours.
 (CHEST 2022, Conditional Recommendation, Very Low Certainty of Evidence)""",
            ...
            pages: [
              TestPageModel(
                title:
                    """● Resume at least 24 hours after low-to-moderate-bleed-risk surgery/procedure.
(CHEST 2022)
● Resumption of anticoagulation the day after low bleeding risk surgery is reasonable. 
(AHA ACC ACCP HRS 2023)""",
                value: "Low-to-moderate-bleed-risk surgery/procedure?",
                type: TestPageTypeEnum.end,
                pages: [
                  TestPageModel(
                    title:
                        """●  In patients with AF on DOAC that has been interrupted for an invasive procedure or surgery, in general,
resumption of anticoagulation the day after low bleeding risk surgery and between the evening of the
second day and the evening of the third day after high bleeding risk surgery is reasonable, as long as
hemostasis has been achieved and further bleeding is not anticipated.
(AHA ACC ACCP HRS 2023 2a, B-NR)""",
                    value: "See Detail",
                    type: TestPageTypeEnum.end,
                  ),
              ...
              TestPageModel(
                title:
                    """● Resume at least 48-72 hours after low-to-moderate-bleed-risk surgery/procedure.
(CHEST 2022)
● Resumption of anticoagulation between the evening of the
second day and the evening of the third day is reasonable. 
(AHA ACC ACCP HRS 2023)""",
                value: "High-bleed-risk surgery/procedure?",
                type: TestPageTypeEnum.end,
                pages: [
