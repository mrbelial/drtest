...
class UFHDosingScreen extends StatelessWidget {
  ...
  String _getDosing() {
    ...
    var dosing = """
● IV administration: 
Start 70 Unit/kg (${70 * w} Unit) (maximum 10000 unit) as bolus and then 15 unit/kg/hour (${15 * w} Unit) (maximum 2000 unit/hour.). (American College of Cardiology)
Check aPTT (seconds) or Anti factor Xa activity (IU/ml) after 6 hour.
● SC administration with monitoring:
17500 unit (250 unit/kg (${250 * w} Unit)) given every 12 hours (as initial 5000 unit IV bolus dose is recommended to obtain rapid anticoagulation)
...
333 unit/kg (${333 * w} Unit) followed by 250 unit/kg (${250 * w} Unit) given every 12 hours. (fixed dose unmonitored dosing regimen)
